...
<TR><TH>ID</TH><TH>User Name</TH><TH>fname</TH><TH>lname</TH><TH>Email</TH><TH>Address</TH><TH>Phone</TH><TH class="edit">points</TH></TR>
...
<?php
 while( $row = $result->fetch_object() ): ?>
  ...
  <td><button class="b3"> <a href="editPoints.php?userName=<?php echo $row->userName  
	
	?>"  class="fa fa-pencil-square-o" aria-hidden="true">  </a> </button> 
