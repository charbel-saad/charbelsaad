...
$result = mysqli_query($db, "SELECT * FROM chat WHERE ( from_userName='$n' OR from_userName='ALL' ) AND( to_userName='$n' OR to_userName='ALL') ORDER BY chat_id  ");
...
if (isset($_POST['submit'])) {
    if($_POST["messages"] ){
        ...
        $db = mysqli_connect("localhost", "root", "", "senior");
        $sql = "INSERT INTO chat (to_userName,from_userName, chat_mssg) VALUES ('ALL','$n', '$message')";
        // execute query
        mysqli_query($db, $sql);
