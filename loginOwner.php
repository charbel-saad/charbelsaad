...
body {
 ...
 <div class="login-page">
  ...
  <form method="post" >
    ...
    <p class="message">Not registered? <a href="ownerReg.php">Create an account</a></p>
</form>
  </div>
</div>
</body>   
	...
	if (empty($_POST['username']) || empty($_POST['password'])) {
		...
		if ($rows == 1) { //username is matching with the password
			...
			if ($res['roleID'] ==1){		
				...
				$_SESSION['role']= "owner";//assign a role
				header("location: profileOwner.php"); // Redirecting To Other Page
