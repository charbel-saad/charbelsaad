...
<div style="text-align: center; margin-top:30px;">
  ...
  <a href="newRewards.php"><button class="icon-btn add-btn">
    <div class="add-icon"></div>
    <div class="btn-txt">Add</div>
  </button></a>
  <a href="removeRew.php"><button class="icon-btn add-btn">  
...
<?php  
    ...
    $result = mysqli_query($con, "SELECT * FROM rewards  ");
    ...
    $res =  mysqli_query($con,$query);
    }else echo "'you Don't have points '";
