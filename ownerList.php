...
<?php 
     ...
     if(isset($_GET['search'])){
        ...
        $sql = "SELECT * FROM user WHERE userName LIKE '%$searchKey%' AND roleID='2' ";
     }else
...
<table border='1' width='50%' 
 align='center'>
 <TR><TH>ID</TH><TH>User Name</TH><TH>Password</TH><TH>fname</TH><TH>lname</TH><TH>Email</TH><TH>Address</TH><TH>Phone</TH><TH class="delete">Delete</TH><TH class="edit">edit</TH></TR>
 <?php while( $row = $result->fetch_object() ): ?>
  ...
  <td><?php echo $row->ID ?></td>
     ...
     <td> <button class="b2"><a href="deletePage.php?ID=<?php echo $row->ID 
	
	?>"> delete </a></button></td>
     <td> <button class="b1"><a href="editPage.php?ID=<?php echo $row->ID 
