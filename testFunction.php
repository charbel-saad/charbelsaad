...
function showSlides() {
  ...
  setTimeout(showSlides, 2000); // Change image every 2 seconds
    ...
    <div class='comment1'>
    <div class=cmnt_box>
    <div><img src=avatar.png style="heigth:100px;width:100px"></div>
    <div class="cmnt_user">John </div>
    <div class="cmnt_date"> 1-1-2020</div>
    <div class="cmnt_body"><p>   it's a good store </p>   </div>
...
<!-- -------------->
    ...
    <div class=cmnt_box>
    <div><img src=avatar.png style="heigth:100px;width:100px"></div>
    <div class="cmnt_user">Davis </div>
    <div class="cmnt_date"> 13-4-2020</div>
    <div class="cmnt_body"><p>  Thanks for your awesome customer service!  </p>   </div>
...
<!-- ---------->
    ...
    <div class=cmnt_box>
    <div><img src=avatar.png style="heigth:100px;width:100px"></div>
    <div class="cmnt_user">Connie </div>
    <div class="cmnt_date"> 28-6-2020</div>
    <div class="cmnt_body"><p>  I just got my first order and I have one word WOW!!!! </p>   </div>
...
<div class='comment2'>
    <div class=cmnt_box>
    <div><img src=avatar.png style="heigth:100px;width:100px"></div>
    <div class="cmnt_user">Sue </div>
    <div class="cmnt_date"> 1-8-2020</div>
    <div class="cmnt_body"><p>  OMG..great store !!!  </p>   </div>
...
<div class='comment1'>
    <div class=cmnt_box>
    <div><img src=avatar.png style="heigth:100px;width:100px"></div>
    <div class="cmnt_user">Amy </div>
    <div class="cmnt_date"> 5-1-2020</div>
    <div class="cmnt_body"><p> I just received my shirts in TWO days I am incredibly </p>   </div>
