...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="editPage.php" class="w3-bar-item w3-button w3-padding"><i class="fa fa-cog fa-fw"></i>  edit profile</a><br><br>
  </div>
</nav>
...
while($row = mysqli_fetch_array($result)) {
    ?>
    <p > ID &nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <input type=text name="ID" value="<?php echo $row['ID']?>" id="ID" readonly="readonly" style="color:black"></p>
